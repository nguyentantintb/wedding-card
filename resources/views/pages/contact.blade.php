...
<div id="maincontainer">
  <section id="product">
    ...
    <div class="row">
      <div class="span9">
      <form action="{{ url('send-contact') }}" class="form-horizontal contactform"  method="POST" id="demo-form" data-parsley-validate="">
         <input type="hidden" name="_token" value="{{ csrf_token() }}"/>
         <fieldset>
          <div class="control-group">
            <label for="name" class="control-label">Name <span class="required">*</span></label>
            <div class="controls">
              <input type="text"  class="required" id="name"  name="name" required="">
            </div>
          </div>
          <div class="control-group">
            <label for="email" class="control-label">Email <span class="required">*</span></label>
            <div class="controls">
              <input type="email"  class="required email" id="email"  name="email" data-parsley-trigger="change" required="">
            </div>
          </div>
          <div class="control-group">
          ...
          <div class="control-group">
            ...
            <div class="controls">
              <textarea  class="required" rows="6" cols="40" id="message" name="messages" required=""  minlength="6"></textarea>
            </div>
          </div>
